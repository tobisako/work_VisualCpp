// Win32Test01.cpp : アプリケーションのエントリ ポイントを定義します。
//
...
void draw(HWND hWnd) {
	...
	if (g_lpBmp != NULL) {
		MessageBox(hWnd , TEXT("とれたっぽい！") , TEXT("結果") , MB_OK);
		...
		MessageBox(hWnd , TEXT("NULL!") , TEXT("結果") , MB_OK);
	}
}
