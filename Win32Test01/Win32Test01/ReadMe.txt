========================================================================
    Win32 アプリケーション: Win32Test01 プロジェクトの概要
========================================================================

この Win32Test01 アプリケーションは、AppWizard により作成されました。

このファイルには、Win32Test01 
...
Win32Test01.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル Win32Test01.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル Win32Test01.rc 
    にインクルードされます。
